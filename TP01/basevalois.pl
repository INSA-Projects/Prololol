...
/* Les demi-freres sont pris en compte */
frere(F,E) :-
	parent(P,F),
	parent(P,E),
	F \== E.
...
/* les tantes éventuelles ne sont pas prises en compte */
cousin(C, E) :- 
	enfant(C, T), 
	oncle(T, E),
	C \== E.
...
le_roi_est_mort_vive_le_roi(A,B,C).
A = charles_V
B = 1380
C = charles_VI
